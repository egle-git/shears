...
//---------------- GO TO RECOOOOOOOOOOOOO ------------------ 
       if(hasRecoInfo == "true"){
            ...
            for (int i(0); i < recoElecSize; ++i) {
                ...
                */
                ...
                double doubleElecTrig = 0;
                if ( elecID > 3 && ElPt->at(i) > 15.) {
                        if ( ElPfIsoRho->at(i) < 0.15 ) countElec++;
                        else invIsoCountElec++;
                 }
                        
                if (leptonIdSum == 22 && TrigHltDiEl & 4)   doubleElecTrig = 2;  //  // Elec17_Elec8 

                patElecTrig_.push_back((double) doubleElecTrig);
                //cout << doubleElecTrig << endl; 
  ...
  /*  
               if (EvtIsRealData ){  if (leptonIdSum == 26 && TrigHltDiMu & (1 <<19)) DimuonTrig = 4 ;
                     if (leptonIdSum == 26 && TrigHltDiMu & (1 <<21)) DimuonTrig = 3 ;
                }
               else  {
                     if (leptonIdSum == 26 && TrigHltDiMu & (1 <<25)) DimuonTrig = 4 ;}
*/
