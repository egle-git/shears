...
public:
  ...
  template<typename T>
  T getUnf(const char* lepSel, const char* variable, const char* param, const T& defaultVal) const;
...
template<typename T>
T ConfigVJets::getUnf(const char* lepSel, const char* variable, const char* param, const T& defaultVal) const{
