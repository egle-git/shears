...
class HistoSetZJets
{
  public:
    ...
    GenH1D *genZPt_Zinc1jetM130_3;
    TH2D *hresponseZPt_Zinc1jet;
    TH2D *hresponseZPt_Zinc1jetM111_130;
    TH2D *hresponseZPt_Zinc1jetM130_3;
    GenH1D *genHadRecoil;
    GenH1D *genJZB;
    GenH1D *genJZB_ptLow;
