...
const int ZJetsMarkerColor[4] = {
    ZJetsLineColor[0], ZJetsLineColor[1], ZJetsLineColor[2], ZJetsLineColor[3]};
...
void customizeRatioGraph(TH1 *hSyst,
...
// TCanvas* makeCrossSectionPlot(TString lepSel, TString variable, bool doNormalized, TH1 *hData,
// TH2D *hCovSyst, TH1 *hGen, TH1 *hGen1 = NULL, TH1 *hGen2 = NULL, double integratedLumi = -1);
