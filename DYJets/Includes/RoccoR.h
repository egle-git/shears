...
struct CrystalBall
{
    ...
    CrystalBall() { init(0, 1, 10, 10); }
    CrystalBall(double m_, double s_, double a_, double n_) { init(m_, s_, a_, n_); }
...
class RocOne
{
  ...
  public:
    ...
    double
    kScaleAndSmearMC(int Q, double pt, double eta, double phi, int n, double u, double w) const;
    double
    kScaleFromGenMC(int Q, double pt, double eta, double phi, int n, double gt, double w) const;
    double
    kGenSmear(double pt, double eta, double v, double u, RocRes::TYPE TT = RocRes::Data) const;
...
class RoccoR
{
  public:
    ...
    double kScaleAndSmearMC(
        int Q, double pt, double eta, double phi, int n, double u, double w, int s = 0, int m = 0)
        const;
    double kScaleFromGenMC(
        int Q, double pt, double eta, double phi, int n, double gt, double w, int s = 0, int m = 0)
        const;
