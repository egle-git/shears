...
class rochcor2015
{
  ...
  private:
    ...
    static constexpr double genm_smr = 9.09292e+01; // gen mass peak with eta dependent gaussian
                                                    // smearing => better match in Z mass profile
                                                    // vs. eta/phi
    static constexpr double genm =
        91.06; // gen mass peak without smearing => Z mass profile vs. eta/phi in CMS note

    static constexpr double mrecm = 9.08878e+01; // rec mass peak in MC
    static constexpr double drecm = 9.09219e+01; // rec mass peak in data
    static constexpr double mgscl_stat = 0.0001; // stat. error of global factor for mass peak in MC
    static constexpr double mgscl_syst =
        3.81651e-03; // syst. error of global factor for mass peak in MC
    static constexpr double dgscl_stat =
        3.62246e-03; // stat. error of global factor for mass peak in data
    static constexpr double dgscl_syst =
        0.0008; // syst. error of global factor for mass peak in data
