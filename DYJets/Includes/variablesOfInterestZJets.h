...
const variableStruct VAROFINTERESTZJETS[] = {
    ...
    //-- jet Pt distribution
    //  {"FirstJetPt_Zinc1jet",          1, 1,      1,          11,              5,             9,
    //  9 ,               6    }, // 1
    //  {"SecondJetPt_Zinc2jet",         1, 1,      1,          14,              8,            11,
    //  7 ,               7    }, // 2
    //  {"ThirdJetPt_Zinc3jet",          1, 1,      1,           6,              9,             8,
    //  7 ,               7    }, // 3
    //{"FourthJetPt_Zinc4jet",         1, 1,      1,           4,              4,             6,
    //5 ,               4    }, // 4
    //{"FifthJetPt_Zinc5jet",          1, 1,      1,           3,              2,             4,
    //3 ,               2    }, // 5
    //-- jets HT distribution
    //  {"JetsHT_Zinc1jet",              1, 1,      1,           9,              4,             7,
    //  3 ,               3    }, // 6
    // {"JetsHT_Zinc2jet",              1, 1,      1,           5,              3,             9,
    // 4 ,               2    }, // 7
    //  {"JetsHT_Zinc3jet",              1, 1,      1,           6,              3,             6,
    //  6 ,               3    }, // 8
    ...
    //  {"FirstJetAbsRapidity_Zinc1jet",         0, 0,      1,          10,              4,
    //  18,            4 ,               5    }, // 11
    //  {"SecondJetAbsRapidity_Zinc2jet",        0, 0,      1,           6,              5,
    //  16,            5 ,               5    }, // 12
    //  {"ThirdJetAbsRapidity_Zinc3jet",         0, 0,      1,           4,              4,
    //  8,            4 ,               5    }, // 13
    //    {"FourthJetAbsRapidity_Zinc4jet",        0, 0,      1,           4,              4,
    //    4,            5 ,               4    }, // 14
    //    {"FifthJetAbsRapidity_Zinc5jet",         0, 0,      1,           3,              2,
    //    2,            2 ,               1    }, // 15
    ...
    //  {"JZB",                   0, 0,      1,           3,              3,             3,
    //  3 ,               3    }, // 1
    //  {"JZB_ptHigh",                   0, 0,      1,           3,              3,             3,
    //  3 ,               3    }, // 1
    //  {"JZB_ptLow",                   0, 0,      1,           3,              3,             3,
    //  3 ,               3    }, // 1
