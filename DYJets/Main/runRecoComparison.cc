...
int main(int argc, char **argv)
{
    ...
    if (argc > 1) {
        for (int i = 1; i < argc; ++i) {
            ...
            //--- asking for help ---
                ...
                std::cout << "\nUsage: \n\t./runRecoComparison [lepSel=(DMu, DE)] [jetPtMin=(int)] "
                             "[jetEtaMax=(int*10)] [histoDir=(path)] [recoCompDir=(path)] [--help]"
                          << std::endl;
            ...
            //--- bad option ---
                ...
                std::cerr << "Please issue ./runRecoComparison --help for more information on "
                             "possible options"
                          << std::endl;
                return 0;
            }
    ...
    std::cout << "Produce event yield table for p_T(jet) > " << jetPtMin << " GeV, |y(jet)| < "
              << jetEtaMax << "\n";
