...
private:
  ...
  void Init() {
    TString fileName = DYTool::Get_OutputPath("CombinedResult_DYXSec_"+type_+".root");

    plotDirPath_ = DYTool::Set_PlotPath("Combination/variousPDF");
  ...
  void ProducePlot() {
    ...
    canvas->SaveAs(plotDirPath_+"/"+canvasName+".pdf");
  }
