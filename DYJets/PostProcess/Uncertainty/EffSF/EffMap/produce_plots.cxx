...
private:
  ...
  TString fileName_ = ""; // -- initializd in Init()
  TString plotDirPath_ = ""; // -- initializd in Init()
  ...
  void Init() {
    fileName_ = DYTool::Get_OutputPath("LeptonEffMap_FullRun2.root");    
    plotDirPath_ = DYTool::Set_PlotPath("EffSF/EffMap");
