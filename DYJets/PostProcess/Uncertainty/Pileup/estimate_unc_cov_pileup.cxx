...
public:
  ...
  void ProduceAndSave() {
    ...
    fileName_output = DYTool::Get_OutputPath(fileName_output);
...
protected:
  ...
  void ProducePlots_DYRun2Result() {
    ...
    comparator.Compare(plotDirPath_+"/DYRun2Result/"+channel_);
  }

  void Init() {
    plotDirPath_ = systType_;
    if( systType_ == "pileup" ) plotDirPath_ = "Pileup";
    if( systType_ == "L1Pref" ) plotDirPath_ = "L1Prefiring";
    plotDirPath_ = DYTool::Set_PlotPath(plotDirPath_);
