# DYJets/PostProcess/Uncertainty
...
1. ```source setup.sh``` (under `DYJets/PostProcess`)
...
NOTE: all results (output `.root` file & plots) will be saved under `DYJets/PostProcess/Output`
