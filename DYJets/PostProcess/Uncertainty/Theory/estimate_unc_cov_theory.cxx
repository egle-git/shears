...
public:
  ...
  void EstimateAndSave() {
    plotDirPath_ = isFPS_ ? "Theory/FPS" : "Theory/fid";
    if( isFPS_ ) {
      fileName_unfolded_.ReplaceAll(".root", "_FPS.root");
      fileName_unc_.ReplaceAll(".root", "_FPS.root");
    }
    fileName_unfolded_ = DYTool::Get_OutputPath(fileName_unfolded_);
...
private:
  ...
  void ProducePlots_Validation() {
    ...
    TString plotPath = plotDirPath_+"/DYRun2Result/validation/"+channel_;
  ...
  void ProducePlots_DYRun2Result_Syst() {
    ...
    TString plotPath_alphaS = plotDirPath_+"/DYRun2Result/syst/alphaS/"+channel_;
    ...
    TString plotPath_scale = plotDirPath_+"/DYRun2Result/syst/scale/"+channel_;
  ...
  void ProducePlots_DYRun2Result_PDFHessian() {
    ...
    TString plotPath = plotDirPath_+"/DYRun2Result/PDFHessian/"+channel_;
    comparator.Compare(plotPath);
  }
