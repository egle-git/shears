...
public:
  ...
  void EstimateAndSave() {
    fileName_unfolded_ = DYTool::Get_OutputPath("Unfolded_SystVar_muP.root");
    fileName_unc_      = DYTool::Get_OutputPath("UncAndCov_muP.root");
...
private:
  ...
  void ProducePlots_Validation() {
    ...
    comparator.Compare(plotDirPath_+"/DYRun2Result/validation");
  }
  ...
  void ProducePlots_DYRun2Result_Syst() {
    ...
    comparator.Compare(plotDirPath_+"/DYRun2Result/syst");
  }
  ...
  void ProducePlots_DYRun2Result_Stat(TString era) {
    ...
    comparator.Compare(plotDirPath_+"/DYRun2Result/stat/"+era);
  }
