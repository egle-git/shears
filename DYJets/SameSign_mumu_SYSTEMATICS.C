...
void SameSign_mumu_SYSTEMATICS(TString era="2016")
{
    ...
    TString filename_fitplus4  = "";
    TString filename_fitminus4 = "";
    TString filename_ratiocon  = "";

    filename_nominal   = "MuMu_"+era+"_samesign_REWEIGHTED";
    filename_fitplus0  = "MuMu_"+era+"_samesign_REWEIGHTED_plus0";
    filename_fitminus0 = "MuMu_"+era+"_samesign_REWEIGHTED_minus0";
    filename_fitplus1  = "MuMu_"+era+"_samesign_REWEIGHTED_plus1";
    filename_fitminus1 = "MuMu_"+era+"_samesign_REWEIGHTED_minus1";
    filename_fitplus2  = "MuMu_"+era+"_samesign_REWEIGHTED_plus2";
    filename_fitminus2 = "MuMu_"+era+"_samesign_REWEIGHTED_minus2";
    filename_fitplus3  = "MuMu_"+era+"_samesign_REWEIGHTED_plus3";
    filename_fitminus3 = "MuMu_"+era+"_samesign_REWEIGHTED_minus3";
    filename_fitplus4  = "MuMu_"+era+"_samesign_REWEIGHTED_plus4";
    filename_fitminus4 = "MuMu_"+era+"_samesign_REWEIGHTED_minus4";
    filename_ratiocon  = "MuMu_"+era+"_samesign_NOTreweighted";

    TFile *f_in_nominal   = new TFile(filename_nominal   + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitplus0  = new TFile(filename_fitplus0  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitminus0 = new TFile(filename_fitminus0 + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitplus1  = new TFile(filename_fitplus1  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitminus1 = new TFile(filename_fitminus1 + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitplus2  = new TFile(filename_fitplus2  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitminus2 = new TFile(filename_fitminus2 + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitplus3  = new TFile(filename_fitplus3  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitminus3 = new TFile(filename_fitminus3 + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitplus4  = new TFile(filename_fitplus1  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_fitminus4 = new TFile(filename_fitminus1 + "/FAKE_EST/dyjets-Fakes.root", "READ");
    TFile *f_in_ratiocon  = new TFile(filename_ratiocon  + "/FAKE_EST/dyjets-Fakes.root", "READ");
    ...
    TH1D *h_fitplus4  = (TH1D*)(f_in_fitplus4 ->Get("mass_wide_range_inc0jet"));
    TH1D *h_fitminus4 = (TH1D*)(f_in_fitminus4->Get("mass_wide_range_inc0jet"));
    ...
    h_fitplus4 ->SetDirectory(0);
    h_fitminus4->SetDirectory(0);
    ...
    h_fitplus4 ->SetStats(0);
    h_fitminus4->SetStats(0);
    ...
    for (uint i = 1; i < h_nominal->GetNbinsX(); ++i)
    {
        ...
        d_fits.push_back(std::abs(h_fitplus4 ->GetBinContent(i) - h_nominal->GetBinContent(i)));
        d_fits.push_back(std::abs(h_fitminus4->GetBinContent(i) - h_nominal->GetBinContent(i)));
        ...
        double d_tot = std::sqrt(d_fit*d_fit + d_rat*d_rat);
    ...
    h_nominal->GetYaxis()->SetRangeUser(1e-1, 1e5);
    ...
    leg->Draw();
    c_syst->Update();
    c_syst->SaveAs("fakes_mumu_syst_"+era+".pdf");
    ...
    h_rel_syst_fit->GetYaxis()->SetRangeUser(0, 100);
    c_rel_syst->SetLogx();
    c_rel_syst->SetGridx();
    c_rel_syst->SetGridy();
    TLegend *leg_rel = new TLegend(0.6, 0.77, 0.95, 0.95);
    ...
    leg_rel->Draw();
    c_rel_syst->Update();
    c_rel_syst->SaveAs("fakes_mumu_syst_rel_"+era+".pdf");
}