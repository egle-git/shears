...
void createTitleVariableAnddSigma(TString variable, bool doNormalized,
				  TString xtitle, TString& title,
				  TString& var, TString& dSigma, bool& sepLumUnc)
{
    sepLumUnc = false;
...
//    }
    ...
    if (xtitle.Index("p_{T} balance") >= 0) {
        ...
        var = "$p_{\\text{T}}^{\\text{bal}}$ \\tiny{[GeV]}";
        dSigma = "$\\frac{d\\sigma}{dp_{\\text{T}}^{\\text{bal}}}$ ${\\scriptstyle [\\frac{\\text{pb}}{\\text{GeV}}]}$";
    }
    ...
    if (xtitle.Index("JZB_ptHigh") >= 0) {
        ...
        var = "JZB \\tiny{[GeV]}";
        dSigma = "$\\frac{d\\sigma}{d\\text{JZB}}$ ${\\scriptstyle [\\frac{\\text{pb}}{\\text{GeV}}]}$";
    ...
    if (variable.Index("ZPt_Zinc0jet") >= 0) {
        ...
        var = "$p_{\\text{T}}(\\text{Z})$ \\tiny{[GeV]}";
        dSigma = "$\\frac{d\\sigma}{dp_{\\text{T}}(\\text{Z})}$ ${\\scriptstyle [\\frac{\\text{pb}}{\\text{GeV}}]}$";
	sepLumUnc = true;
