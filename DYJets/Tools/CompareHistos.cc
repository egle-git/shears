...
///////////////
  ...
  if(fitSwitch){
    ...
    gaussfunc->SetParameter(0,1.0);     gaussfunc->SetParName(0,"const");  
    gaussfunc->SetParameter(2,5.0);     gaussfunc->SetParName(2,"sigma");  
    gaussfunc->SetParameter(1,95.0);    gaussfunc->SetParName(1,"mean");
...
////////////////////
  if(!fitSwitch){
    ...
    bwfunc->SetParameter(0,1.0);     bwfunc->SetParName(0,"const");
    bwfunc->SetParameter(2,5.0);     bwfunc->SetParName(1,"sigma");
    bwfunc->SetParameter(1,95.0);    bwfunc->SetParName(2,"mean");
