# This file was copied from etc/cmake/FindROOT.cmake in the ROOT repo.
# The function ROOT_GENERATE_DICTIONARY was modified to support per-target include paths.
...
#----------------------------------------------------------------------------
# function ROOT_GENERATE_DICTIONARY( target
#                                    dictionary
#                                    header1 header2 ...
#                                    LINKDEF linkdef1 ...
#                                    OPTIONS opt1...)
function(ROOT_GENERATE_DICTIONARY target dictionary)
  ...
  foreach(fp ${ARG_UNPARSED_ARGUMENTS})
    if(${fp} MATCHES "[*?]") # Is this header a globbing expression?
      ...
      message("Looking for ${fp} in ${incdirs}...")
