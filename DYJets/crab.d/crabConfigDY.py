...
# DMu or DE
config.JobType.scriptArgs = ['cfg=vjets_silver_lepSel_crabDY.cfg']
...
config.JobType.inputFiles += ['vjets_silver_DMu_crabDY.cfg', 'vjets_silver_DE_crabDY.cfg']

config.section_('Data')
config.Data.unitsPerJob = 1
config.Data.totalUnits = 144
