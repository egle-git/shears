runHZZanalysis: runHZZ2l2nu.cc HZZ2l2nuLooper.o SmartSelectionMonitor.o Utils.o
	g++ runHZZ2l2nu.cc -L/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed6/lib -lGui -lCore -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lThread -lMultiProc -pthread -lm -ldl -rdynamic -pthread -std=c++11 -Wno-deprecated-declarations -m64 -I/cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.06.00-ikhhed6/include HZZ2l2nuLooper.o SmartSelectionMonitor.o Utils.o -o runHZZanalysis
