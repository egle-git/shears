...
namespace Rivet {
  ...
  class CMS_2015_I1409817 : public Analysis {
  public:

    /// Constructor
    CMS_2015_I1409817()
      : Analysis("CMS_2015_I1409817")
    {  }
    ...
    void analyze(const Event& event) {;
      ...
      const Particles& dressedLeptons =  zmumuFS.constituents();
      ...
      foreach (const Jet& j, jets) {
        ...
        foreach (const Particle& l, dressedLeptons) {
          if (Rivet::deltaR(j, l) < 0.4) { //changed on March 23
            overlap = true;
            break;
          }
        }
  ...
  DECLARE_RIVET_PLUGIN(CMS_2015_I1409817);
