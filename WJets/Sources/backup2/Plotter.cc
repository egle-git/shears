             ...
             bool doRoch = 0, bool doFlat = 0, bool doVarWidth = 1)
{
    ...
    file[0] = new TFile("HistoFiles/SMu_13TeV_Data_dR_5311_EffiCorr_0_TrigCorr_1_Syst_0_JetPtMin_30_VarWidth_BVeto.root", "READ");
    legendNames[0] = " #mu#nu ";
    legendNames[0] += "Data";
    
    //    file[1] = new TFile("HistoFiles/SMu_8TeV_TTJets_dR_5311_EffiCorr_1_TrigCorr_1_Syst_0_JetPtMin_30_VarWidth.root", "READ");
    //    legendNames[1] = ProcessInfo[11].legend;
    //    //Colors[1] = ProcessInfo[11].color;
    //    Colors[1] = kPink-6;
    
    file[1] = new TFile("HistoFiles/SMu_13TeV_WJetsALL_MIX_UNFOLDING_dR_5311_EffiCorr_1_TrigCorr_1_Syst_0_JetPtMin_30_VarWidth_BVeto.root", "READ");
    legendNames[1] = ProcessInfo[1].legend;
    //Colors[1] = ProcessInfo[1].color;
    Colors[1] = kOrange-3;
