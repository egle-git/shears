...
`./grow_baobabs --catalog datasets.txt`
...
Note: when the warden command is run, it creates two files, warden_summary and warden_last_log in the directory it is executing from.
